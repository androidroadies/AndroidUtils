...
abstract class ImageViewTouchBase extends ImageView {
    ...
    public void setImageBitmapResetBase(final Bitmap bitmap,
                                        @SuppressWarnings("SameParameterValue") final boolean resetSupp) {
    ...
    private float getValue(Matrix matrix, @SuppressWarnings("SameParameterValue") int whichValue) {
    ...
    void zoomTo(final float scale, final float centerX,
                final float centerY, @SuppressWarnings("SameParameterValue") final float durationMs) {
    ...
    private void zoomTo(@SuppressWarnings("SameParameterValue") float scale) {
    ...
    private void zoomIn(@SuppressWarnings("SameParameterValue") float rate) {
    ...
    private void zoomOut(@SuppressWarnings("SameParameterValue") float rate) {
